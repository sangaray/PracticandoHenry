(() => {
  var e = {
      796: (e) => {
        e.exports = function (e) {
          ...
          (c.innerHTML = t),
            (u.innerHTML = `Year: ${n}`),
            (l.innerHTML = `Director: ${r}`),
            (f.innerHTML = `Duration: ${o}`),
            (d.innerHTML = `Genre: ${s.join(", ")}`),
            (p.innerHTML = `Rating: ${i}`),
            (h.src = a || "default-image.jpg"),
            c.classList.add("movieTitle"),
            u.classList.add("movieYear"),
            l.classList.add("movieDirector"),
            f.classList.add("movieDuration"),
            d.classList.add("movieGenre"),
            p.classList.add("movieRate"),
            h.classList.add("moviePoster");
          const m = document.createElement("div");
          return (
            m.classList.add("movieCard"),
            m.appendChild(c),
            m.appendChild(h),
            m.appendChild(l),
            m.appendChild(u),
      ...
      748: (e, t, n) => {
        const r = n(796),
          o = document.getElementById("cardsContainer");
        e.exports = function (e) {
          (o.innerHTML = ""),
            e.forEach((e) => {
              const t = r(e);
      ...
      425: (e, t, n) => {
        ...
        const j =
          ...
          N = (e) => !f(e) && e !== j,
          L =
            ((P = "undefined" != typeof Uint8Array && s(Uint8Array)),
            (e) => P && e instanceof P);
        var P;
            ...
            H
              ...
              ? ((J = `axios@${Math.random()}`),
                ...
                j.addEventListener(
                  "message",
                  ({ source: e, data: t }) => {
                    e === j && t === J && W.length && W.shift()();
                  },
                  !1
                ),
                (e) => {
                  W.push(e), j.postMessage(J, "*");
                })
              : (e) => setTimeout(e));
        var H, z, J, W;
        const K =
          ...
          transformRequest: [
            function (e, t) {
              const n = t.getContentType() || "",
                ...
                o = $.isObject(e);
              if (
                (o && $.isHTMLForm(e) && (e = new FormData(e)), $.isFormData(e))
              )
        ...
        Te.accessor([
          ...
          $.reduceDescriptors(Te.prototype, ({ value: e }, t) => {
        ...
        const Ne = (e, t, n = 3) => {
          ...
          Pe =
            ...
            (...t) =>
              $.asap(() => e(...t));
        var _e = me.hasStandardBrowserEnv
            ? (function () {
                const e =
                    me.navigator &&
        ...
        const Be = (e) => (e instanceof ve ? { ...e } : e);
        function De(e, t) {
          t = t || {};
          const n = {};
          function r(e, t, n) {
        ...
        var ke = (e) => {
            ...
            if (
              ...
              (o && $.isFunction(o) && (o = o(t)), o || (!1 !== o && _e(t.url)))
            ) {
              const e = s && i && Fe.read(i);
              e && a.set(s, e);
            }
            return t;
          },
          qe =
            ...
            function (e) {
              return new Promise(function (t, n) {
                const r = ke(e);
                let o = r.data;
                const s = ve.from(r.headers).normalize();
                let i,
                  a,
                  c,
                  u,
                ...
                m.open(r.method.toUpperCase(), r.url, !0),
                  ...
                  p &&
                    (([c, l] = Ne(p, !0)), m.addEventListener("progress", c)),
                  d &&
                    m.upload &&
                    (([a, u] = Ne(d)),
              ...
              const o = function (e) {
                if (!n) {
                  ...
                  r.abort(
                    t instanceof V
                      ? t
                      : new xe(t instanceof Error ? t.message : t)
                  );
                }
              };
              let s =
        ...
        const $e = (e, ...t) => {
          ...
          Xe = { stream: Ge && ((e) => e.body) };
        var Qe;
        ze &&
          ((Qe = new Response()),
          ["text", "arrayBuffer", "blob", "formData", "stream"].forEach((e) => {
            !Xe[e] &&
              (Xe[e] = $.isFunction(Qe[e])
                ? (t) => t[e]()
                : (t, n) => {
                    throw new V(
          ...
          fetch:
            ...
            (async (e) => {
              ...
              try {
                ...
                let s = await fetch(p);
                const i = Ge && ("stream" === u || "response" === u);
                if (Ge && (a || (i && m))) {
                  const e = {};
                ...
                u = u || "text";
                let b = await Xe[$.findKey(Xe, u) || "text"](s, e);
                return (
                  !i && m && m(),
                  await new Promise((t, n) => {
                    je(t, n, {
                      data: b,
                      headers: ve.from(s.headers),
                      status: s.status,
        ...
        var tt = (e) => {
          ...
          for (let s = 0; s < t; s++) {
            ...
            if (
              ((n = e[s]),
              (r = n),
              !et(n) && ((r = Ye[(t = String(n)).toLowerCase()]), void 0 === r))
            )
        ...
        function rt(e) {
          return (
            ...
            tt(e.adapter || ge.adapter)(e).then(
              function (t) {
                return (
                  nt(e),
        ...
        class ct {
          ...
          getUri(e) {
            return ie(
              Ue((e = De(this.defaults, e)).baseURL, e.url),
              e.params,
              e.paramsSerializer
            );
          }
        ...
        const ht = (function e(t) {
          const n = new ut(t),
            o = r(ut.prototype.request, n);
          return (
            $.extend(o, ut.prototype, n, { allOwnKeys: !0 }),
        ...
        (ht.Axios = ut),
          ...
          (ht.mergeConfig = De),
          (ht.AxiosHeaders = ve),
          (ht.formToJSON = (e) => ye($.isHTMLForm(e) ? new FormData(e) : e)),
          (ht.getAdapter = tt),
  ...
  (async () => {
    try {
      const e = await r.get("https://students-api.up.railway.app/movies");
      o(e.data);
    } catch (e) {
