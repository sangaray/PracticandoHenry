export const CardProduct = ({ id, title, price, image }) => {
  return (
    <div className="flex flex-col self-center w-full max-w-xs overflow-hidden bg-gray-700">
      <a
      ...
      <div className="px-5 pb-5 mt-4">
        ...
        <a
          href="#"
          className="hover:border-white/40 flex items-center justify-center rounded-md border border-transparent">
          <svg
